          ...
          <ul class="nav-list">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a href="/pierrot" class="dropdown-link">{{ $t('nav.pierrot') }}</a>
                </li>
                <li>
                  <a href="/harlequin" class="dropdown-link">{{ $t('nav.harlequin') }}</a>
                </li>
                <li>
                  <a href="/jester" class="dropdown-link">{{ $t('nav.jester') }}</a>
                </li>
                <li>
                  <a href="/doctor" class="dropdown-link">{{ $t('nav.doctor') }}</a>
                </li>
                <li>
                  <a href="/ticket-taker" class="dropdown-link">{{ $t('nav.ticketTaker') }}</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
          ...
          <ul class="mobile-nav-list">
            ...
            <li class="nav-item mobile-dropdown" :class="{ open: isMobileDropdownOpen }">
              ...
              <ul class="mobile-dropdown-menu">
                <li>
                  <a href="/pierrot" class="nav-link" @click="closeMobileMenu">{{
                    $t('nav.pierrot')
                  }}</a>
                </li>
                <li>
                  <a href="/harlequin" class="nav-link" @click="closeMobileMenu">{{
                    $t('nav.harlequin')
                  }}</a>
                </li>
                <li>
                  <a href="/jester" class="nav-link" @click="closeMobileMenu">{{
                    $t('nav.jester')
                  }}</a>
                </li>
                <li>
                  <a href="/doctor" class="nav-link" @click="closeMobileMenu">{{
                    $t('nav.doctor')
                  }}</a>
                </li>
                <li>
                  <a href="/ticket-taker" class="nav-link" @click="closeMobileMenu">{{
                    $t('nav.ticketTaker')
                  }}</a>
                </li>
              </ul>
