// Dados do blog em português
export default [
  {
    id: 1,
    title: "Bem-vindo ao blog The Freak Circus",
    description: "Esta é uma postagem de blog de teste para demonstrar a funcionalidade do blog. Saiba mais sobre as últimas atualizações, insights de personagens e notícias de desenvolvimento da visual novel The Freak Circus.",
    tags: ["The Freak Circus", "Blog", "Visual Novel", "Desenvolvimento", "Notícias"],
    isHome: false,
    publishDate: "2025-01-15",
    imageUrl: "/images/about-img.webp",
    imageAlt: "Captura de tela da visual novel The Freak Circus",
    seo: {
      title: "Bem-vindo ao blog The Freak Circus - Últimas atualizações e notícias",
      description: "Mantenha-se atualizado com as últimas notícias, insights de personagens e atualizações de desenvolvimento da visual novel The Freak Circus. Leia nosso blog para conteúdo exclusivo e informações dos bastidores.",
      keywords: "Blog The Freak Circus, notícias de visual novel, desenvolvimento de jogos, Pierrot, Harlequin, atualizações do jogo de circo"
    },
    addressBar: "welcome-to-the-freak-circus-blog",
    detailsHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <h2>Bem-vindo ao blog The Freak Circus</h2>
        <p>Bem-vindo ao blog oficial da visual novel <strong>The Freak Circus</strong>! Esta é uma postagem de blog de teste criada para demonstrar a funcionalidade do blog do nosso site.</p>
        
        <h3>Sobre este blog</h3>
        <p>Este blog servirá como uma plataforma para compartilhar as últimas atualizações, insights de personagens, notícias de desenvolvimento e conteúdo exclusivo relacionado à visual novel The Freak Circus. Aqui, você encontrará:</p>
        <ul>
          <li><strong>Atualizações de desenvolvimento:</strong> Mantenha-se informado sobre os últimos recursos, melhorias e adições de conteúdo ao jogo.</li>
          <li><strong>Insights de personagens:</strong> Análises profundas das personalidades, históricos e motivações de personagens como <a href="/pierrot">Pierrot</a> e <a href="/harlequin">Harlequin</a>.</li>
          <li><strong>Bastidores:</strong> Saiba mais sobre o processo criativo, decisões de design e a jornada de dar vida ao The Freak Circus.</li>
          <li><strong>Destaques da comunidade:</strong> Mostra de arte de fãs, discussões da comunidade e experiências dos jogadores.</li>
        </ul>
        
        <h3>O que esperar</h3>
        <p>Estamos comprometidos em fornecer atualizações regulares e conteúdo envolvente para nossa comunidade. Seja você um fã de longa data ou novo no The Freak Circus, este blog ajudará você a permanecer conectado com o mundo que estamos construindo.</p>
        
        <p>Obrigado pelo seu apoio contínuo e esperamos compartilhar mais conteúdo emocionante com você no futuro!</p>
      </div>
    `
  },
  ...
  {
    "id": 2,
    "title": "The Freak Circus Dia 2: Guia Completo de Walkthrough e História",
    "description": "Um guia completo da atualização The Freak Circus Dia 2, cobrindo novos personagens, localizações das tendas, cenas ocultas, múltiplos finais e a trágica lenda de Columbina que molda a história.",
    "tags": ["The Freak Circus", "Dia 2", "Walkthrough", "Guia", "História", "Personagens", "Pierrot", "Harlequin", "Jester", "Doctor", "Ticket Taker"],
    "isHome": true,
    "publishDate": "2025-12-16",
    "imageUrl": "/images/blog/blog02.webp",
    "imageAlt": "Atualização The Freak Circus Dia 2 com novos personagens e localizações das tendas",
    "seo": {
      "title": "The Freak Circus Dia 2: Guia Completo de Walkthrough e História | thefreakcircus.org",
      "description": "Guia completo de walkthrough da atualização The Freak Circus Dia 2. Conheça novos personagens (Jester, Doctor, Ticket Taker), localizações das tendas, cenas ocultas, múltiplos finais e a lenda de Columbina.",
      "keywords": "The Freak Circus Dia 2, guia de walkthrough, atualização Dia 2, Jester, Doctor, Ticket Taker, Pierrot, Harlequin, lenda de Columbina, cenas ocultas, múltiplos finais, guia de visual novel"
    },
    "addressBar": "the-freak-circus-dia-2-guia-completo-walkthrough",
    "detailsHtml": `
        <div class="blog-content-wrapper">
          <p>A atualização <strong>The Freak Circus Dia 2</strong> aumenta significativamente as apostas do jogo. Enquanto o Dia 1 apresentou os personagens e estabeleceu a base do horror psicológico, o Dia 2 mergulha os jogadores em uma narrativa mais sombria envolvendo sequestro, manipulação psicológica e uma lore profunda sobre a rivalidade entre <a href="/pierrot">Pierrot</a> e <a href="/harlequin">Harlequin</a>.</p>
          
          <p>Este guia completo detalha os principais eventos, novas localizações, interações entre personagens, cenas ocultas e múltiplos finais que você encontrará durante o segundo dia da sua jornada pelo circo.</p>
          
          <h2>Acordando em Cativeiro: Pierrot vs. Harlequin</h2>
          
          <p>O Dia 2 começa em um quarto desconhecido dentro da tenda do circo. Você acorda acorrentado a uma cama, revelando imediatamente o lado mais sombrio da obsessão de Pierrot. Ele afirma que drogou e sequestrou você para “protegê-lo” dos outros, demonstrando sua natureza possessiva e instável.</p>
          
          <h3>Interações Principais:</h3>
          
          <p><strong><a href="/pierrot">Pierrot</a>:</strong> Apesar de suas ações, ele parece gentil, porém instável. Ele pede sua confiança e deixa uma máscara com você, instruindo-o a permanecer em silêncio. Sua obsessão é clara — ele quer mantê-lo seguro, mas seus métodos são extremos. Eventualmente, ele lhe entrega um <strong>Bilhete Vermelho</strong> e diz para retornar ao circo naquela noite para evitar suspeitas dos outros.</p>
          
          <p><strong><a href="/harlequin">Harlequin</a>:</strong> Ele invade o quarto enquanto Pierrot está ausente, destacando o contraste entre os dois personagens. Enquanto Pierrot quer escondê-lo, Harlequin quer “brincar” e caçar. Ele ameaça você com uma faca, mas fica intrigado com suas reações, mostrando sua natureza predatória e manipuladora.</p>
          
          <p><strong>O Conflito:</strong> A cena termina com um confronto tenso entre os dois rivais. Esse momento estabelece a dinâmica central: Pierrot age como um escudo, enquanto Harlequin é o predador. Você acaba recebendo o Bilhete Vermelho e é instruído a retornar ao circo naquela noite.</p>
          
          <h2>Explorando o Circo: As Três Tendas</h2>
          
          <img src="/images/blog/blog02-01.webp" alt="Atualização The Freak Circus Dia 2 apresentando as três tendas" class="blog-image">
  
          <p>Ao retornar ao terreno do circo, a atmosfera muda drasticamente. A atualização do Dia 2 permite explorar tendas de atrações específicas, cada uma revelando diferentes aspectos dos segredos sombrios do circo.</p>
          
          <h3>A Tenda dos Espelhos (Tenda Azul)</h3>
  
          <img src="/images/blog/blog02-02.webp" alt="Atualização The Freak Circus Dia 2 apresentando a Tenda dos Espelhos" class="blog-image">
          
          <p>Um dos locais mais importantes é a <strong>Tenda dos Espelhos</strong>, também conhecida como Tenda Azul. Lá dentro, você encontra o <strong>Ticket Taker</strong>, que manipula a realidade através de reflexos distorcidos.</p>
          
          <p>Os espelhos mostram versões distorcidas dos outros personagens:</p>
          <ul>
            <li><strong>Reflexo de Pierrot:</strong> Implora para que você fique com ele para sempre, mostrando sua necessidade desesperada da sua presença.</li>
            <li><strong>Reflexo de Harlequin:</strong> É agressivo e zomba da sua fraqueza, revelando sua natureza predatória.</li>
          </ul>
          
          <p><strong>A Lição:</strong> O Ticket Taker alerta para não confiar nos seus olhos. Os horrores que você vê nos espelhos refletem a verdadeira natureza dos monstros ao seu redor. Esta cena serve como um aviso crucial sobre os perigos que estão por vir.</p>
          
          <h3>Encontrando o Doctor (Tenda Ciano)</h3>
  
          <img src="/images/blog/blog02-03.webp" alt="Atualização The Freak Circus Dia 2 apresentando o Doctor" class="blog-image">
          
          <p>Um novo personagem é introduzido na <strong>Tenda Ciano</strong>: <strong>O Doctor</strong>. Ele aparece como um médico da peste e traz um tema de horror médico ao jogo, adicionando mais uma camada de terror psicológico.</p>
          
          <p><strong>O Exame:</strong></p>
          <ul>
            <li>O Doctor amarra você a uma mesa para medir sua resposta ao medo e níveis de adrenalina.</li>
            <li>Ele menciona que a “sangria” tem efeitos calmantes, mostrando sua filosofia médica distorcida.</li>
            <li>Ele valoriza a obediência e acha o medo fascinante, sugerindo seus experimentos sombrios.</li>
          </ul>
          
          <p><strong>Dica de Sobrevivência:</strong> O Doctor sugere que suas reações são diferentes das “bonecas” ou vítimas anteriores, indicando que você pode ter um papel único nos jogos distorcidos do circo.</p>
          
          <h3>A Apresentação do Jester (Tenda Roxa/Preta)</h3>
  
          <img src="/images/blog/blog02-04.webp" alt="Atualização The Freak Circus Dia 2 apresentando a performance do Jester" class="blog-image">
          
          <p>A revelação de lore mais importante do Dia 2 acontece durante a apresentação no palco da <strong>Tenda Roxa/Preta</strong>. O <strong>Jester</strong> conta uma história trágica usando fantoches que explica a origem do circo e a raiz do ódio entre Pierrot e Harlequin.</p>
          
          <h2>A Lenda de Columbina: Lore Central Revelada</h2>
          
          <p>Durante a apresentação do Jester, a história trágica de Columbina é revelada, explicando a animosidade profunda entre Pierrot e Harlequin.</p>
          
          <h3>Resumo da História:</h3>
          
          <ul>
            <li><strong>O Monstro Silencioso:</strong> Representa Pierrot. Ele amava uma garota chamada Columbina, conhecida como “A Flor”.</li>
            <li><strong>O Outro:</strong> Representa Harlequin, conhecido como “O Veneno”. Ele ficou com ciúmes porque Columbina amava o Monstro Silencioso e não a ele.</li>
            <li><strong>A Tragédia:</strong> Consumido pelo ciúme, Harlequin envenenou Columbina. Esse ato é a raiz do ódio entre Pierrot e Harlequin, e o Jester sugere que a história está se repetindo com você, o protagonista.</li>
          </ul>
          
          <p>Essa lenda é uma peça crucial da narrativa, revelando por que Pierrot e Harlequin estão presos em um conflito eterno e por que você, como a nova “Columbina”, está preso no meio.</p>
          
          <h2>Sistema de Cenas Ocultas</h2>
          
          <p>O Dia 2 introduz um novo <strong>Sistema de Cenas Ocultas</strong>, que adiciona profundidade e rejogabilidade ao jogo.</p>
          
          <h3>Como Desbloquear Cenas Ocultas:</h3>
          <ul>
            <li>Fazer escolhas específicas em pontos-chave</li>
            <li>Interagir com personagens de maneiras únicas</li>
            <li>Explorar diferentes opções de diálogo</li>
            <li>Completar certas sequências em ordens específicas</li>
          </ul>
          
          <h3>Cenas Ocultas Disponíveis:</h3>
          <ul>
            <li>Interações adicionais com Pierrot e Harlequin</li>
            <li>Cenas estendidas com novos personagens (Jester, Doctor, Ticket Taker)</li>
            <li>Revelações de backstory e desenvolvimento de personagens</li>
            <li>Easter eggs e referências secretas</li>
          </ul>
          
          <p><strong>Acesso pelo Menu:</strong> Todas as cenas ocultas desbloqueadas podem ser acessadas diretamente pelo menu principal.</p>
          
          <h2>Múltiplos Finais e Escolhas</h2>
          
          <p>O Dia 2 apresenta vários caminhos ramificados e finais diferentes, baseados nas suas escolhas.</p>
          
          <h3>Pontos de Decisão Importantes:</h3>
          <ul>
            <li>Como você reage ao sequestro de Pierrot</li>
            <li>Suas reações às ameaças de Harlequin</li>
            <li>Escolhas feitas em cada tenda (Espelhos, Doctor, Jester)</li>
            <li>Se você confia ou resiste aos personagens</li>
            <li>Como lida com o confronto final</li>
          </ul>
          
          <h3>Variações de Final:</h3>
          <ul>
            <li>Diferentes resultados de relacionamento com Pierrot e Harlequin</li>
            <li>Vários níveis de confiança e suspeita</li>
            <li>Diferentes revelações sobre os segredos do circo</li>
            <li>Implicações variadas para capítulos futuros</li>
          </ul>
          
          <h2>Itens e Colecionáveis</h2>
          
          <p>Ao longo do Dia 2, você pode coletar vários itens importantes para capítulos futuros.</p>
          
          <h3>Itens Principais:</h3>
          <ul>
            <li><strong>Bilhete Vermelho:</strong> Dado por Pierrot, permite retornar ao circo sem levantar suspeitas</li>
            <li><strong>Broches:</strong> Vários broches que podem ter significado posteriormente</li>
            <li><strong>A Máscara:</strong> Deixada por Pierrot, pode ter significado simbólico</li>
          </ul>
          
          <p><strong>Gerenciamento de Inventário:</strong> Fique atento aos itens coletados, pois eles podem desbloquear novos diálogos ou caminhos da história.</p>
          
          <h2>Atualizações Visuais e de Áudio</h2>
          
          <p>A atualização do Dia 2 traz melhorias significativas na apresentação do jogo:</p>
          
          <h3>Melhorias Visuais:</h3>
          <ul>
            <li>Mais de 100 novas imagens, incluindo sprites, expressões e cenários</li>
            <li>Sprites animados para certos personagens</li>
            <li>Iluminação e efeitos visuais aprimorados</li>
            <li>Animações e expressões de personagens melhoradas</li>
            <li>Novo design do menu do jogo</li>
          </ul>
          
          <h3>Melhorias de Áudio:</h3>
          <ul>
            <li>Novos efeitos sonoros</li>
            <li>Faixas adicionais de música de fundo</li>
            <li>Áudio atmosférico aprimorado</li>
          </ul>
          
          <h2>Final do Dia 2 e Mistérios Futuros</h2>
          
          <p>A atualização termina com um confronto tenso na rua. Harlequin tenta “seduzi-lo” ou capturá-lo novamente, mas Pierrot intervém para protegê-lo.</p>
          
          <h3>Considerações Finais do Dia 2:</h3>
          
          <ul>
            <li><strong>Dinâmica dos Personagens:</strong> Pierrot age como um escudo, enquanto Harlequin é o predador. O Jester atua como o observador que conhece todos os segredos.</li>
            <li><strong>Inventário:</strong> Ao final do dia, você deve ter coletado itens importantes como broches e o Bilhete Vermelho.</li>
            <li><strong>A Sombra:</strong> Ao voltar para casa, o jogo sugere a presença de uma “enorme sombra com olhos dourados”, preparando um grande mistério futuro.</li>
          </ul>
          
          <h2>O Que Esperar a Seguir</h2>
          
          <p>O conteúdo do Dia 2 transforma The Freak Circus de um simples simulador de encontros em uma experiência de horror psicológico.</p>
          
          <p>Com novos personagens, cenas ocultas, múltiplos finais e a revelação da lenda de Columbina, o Dia 2 prepara o terreno para narrativas ainda mais sombrias.</p>
          
          <p>Fique atento às próximas atualizações — e lembre-se: em The Freak Circus, nada é o que parece, e confiar é um luxo que você não pode ter.</p>
