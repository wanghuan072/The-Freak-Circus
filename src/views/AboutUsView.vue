    ...
    <main class="main-content">
      <div class="container">
        <div class="page-header">
          ...
          <p>{{ $t('AboutPage.header.lastUpdated') }}</p>
        </div>
        ...
        <div class="about-content">
          ...
          <section>
            ...
            <ul>
              <li>
                <strong>{{ $t('AboutPage.whatWeOffer.guides') }}</strong>
              </li>
              <li>
                <strong>{{ $t('AboutPage.whatWeOffer.updates') }}</strong>
              </li>
              <li>
                <strong>{{ $t('AboutPage.whatWeOffer.community') }}</strong>
              </li>
              <li>
                <strong>{{ $t('AboutPage.whatWeOffer.features') }}</strong>
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2>{{ $t('AboutPage.community.title') }}</h2>
            <p>{{ $t('AboutPage.community.description') }}</p>
          </section>

          <section>
            <h2>{{ $t('AboutPage.qualityAssurance.title') }}</h2>
            <p>{{ $t('AboutPage.qualityAssurance.description') }}</p>
          </section>

          <section>
            <h2>{{ $t('AboutPage.regularUpdates.title') }}</h2>
          ...
          <section>
            ...
            <p>
              {{ $t('AboutPage.contactUs.description1') }}
          ...
          <section>
            ...
            <p>{{ $t('AboutPage.joinCommunity.description') }}</p>
          </section>
        </div>
      </div>
    </main>
