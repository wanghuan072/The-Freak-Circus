<template>
  <div class="home-page">
      ...
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div class="hero-description">
            ...
            <div class="hero-platforms">
              <p>
                <strong>{{ $t('HomePage.hero.platforms') }}</strong>
              </p>
            </div>
          </div>
          <div class="hero-buttons">
            <button class="btn btn-primary" @click="scrollToGame">
              {{ $t('HomePage.hero.playButton') }}
            </button>
        ...
        <aside v-if="isMobile">
          <div
            ...
            data-devices="m:1,t:1,d:1"
            style="max-width: 100%; min-height: 296px"
            class="demand-supply"
          ></div>
        </aside>
      </div>
        ...
        <div class="about-content">
          ...
          <div class="features-grid">
            <div class="feature-card">
              <h3>{{ $t('HomePage.about.feature1') }}</h3>
              <p>{{ $t('HomePage.about.feature1Desc') }}</p>
            </div>
            <div class="feature-card">
              <h3>{{ $t('HomePage.about.feature2') }}</h3>
              <p>{{ $t('HomePage.about.feature2Desc') }}</p>
            </div>
            <div class="feature-card">
              <h3>{{ $t('HomePage.about.feature3') }}</h3>
              <p>{{ $t('HomePage.about.feature3Desc') }}</p>
            </div>
            <div class="feature-card">
              <h3>{{ $t('HomePage.about.feature4') }}</h3>
    ...
    <section class="section characters">
      <div class="container">
        <h2 class="section-title">{{ $t('HomePage.characters.title') }}</h2>
        <div class="characters-content">
          <div class="characters-intro">
            <p>{{ $t('HomePage.characters.subtitle') }}</p>
          </div>
          <div class="characters-grid">
            <div class="character-card">
              ...
              <div class="character-info">
                ...
                <a href="/pierrot" class="character-link"
                  >{{ $t('HomePage.characters.pierrotLearnMore') }} →</a
                >
              </div>
            </div>
            <div class="character-card">
              ...
              <div class="character-info">
                ...
                <a href="/harlequin" class="character-link"
                  >{{ $t('HomePage.characters.harlequinLearnMore') }} →</a
                >
              </div>
            </div>
            <div class="character-card">
    ...
    <section class="section cta">
      <div class="container">
        <h2 class="section-title">{{ $t('HomePage.cta.title') }}</h2>
        <div class="cta-content">
          <p class="cta-text">{{ $t('HomePage.cta.subtitle') }}</p>

          <div class="cta-buttons">
            <a
              href="https://garula.itch.io/the-freak-circus/download/eyJpZCI6MzYzMTY4NSwiZXhwaXJlcyI6MTc1ODc5NDEwMX0%3d.UCS9ynX2%2fBoZ7LMylvRkrpUsjAQ%3d"
              target="_blank"
              class="btn btn-primary btn-large"
              >{{ $t('HomePage.cta.downloadButton') }}</a
            >
            <a href="/wiki" class="btn btn-secondary btn-large">{{
              $t('HomePage.cta.learnButton')
            }}</a>
          </div>
...
.section.play-game .play-game-content {
  color: #fff;
  background: rgba(0, 0, 0, 0.4);
  backdrop-filter: blur(8px);
  border-radius: 15px;
...
/* Characters Section 内容样式 */
.section.characters .characters-content {
  color: #fff;
  background: rgba(0, 0, 0, 0.4);
  backdrop-filter: blur(8px);
  border-radius: 15px;
...
.play-button:hover {
  ...
  background: linear-gradient(135deg, #ff7b7b, #ff9a63);
}
...
.section.about {
  background-image: url('/images/home_img_04.webp');
}
