...
const helmetItems = computed(() => {
  ...
  if (import.meta.env.DEV) {
    console.log(`[ItemsArmorView] helmetItems - lang: ${currentLang}, targetType: "${targetType}", count: ${filtered.length}, total items: ${itemsData.value?.length || 0}`)
  }
  return filtered
})
const lowerArmorItems = computed(() => {
  ...
  const filtered = filterByType(targetType)
  if (import.meta.env.DEV) {
    console.log(`[ItemsArmorView] lowerArmorItems - lang: ${currentLang}, targetType: "${targetType}", count: ${filtered.length}`)
  }
  return filtered
})
const upperArmorItems = computed(() => {
  ...
  const filtered = filterByType(targetType)
  if (import.meta.env.DEV) {
    console.log(`[ItemsArmorView] upperArmorItems - lang: ${currentLang}, targetType: "${targetType}", count: ${filtered.length}`)
  }
  return filtered
})
...
onMounted(async () => {
  ...
  if (import.meta.env.DEV) {
    console.log(`[ItemsArmorView] onMounted - locale.value: ${locale.value}, getCurrentLocale(): ${currentLang}`)
  }
